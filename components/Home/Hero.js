        ...
        <div className="px-12 py-2">
            <div className="flex bg-secondary rounded-lg w-full h-full items-center py-16 px-8">
                <div className="w-1/2 flex flex-col gap-8">
                    ...
                    <a href="/blog" className="h-12 w-40 bg-primary flex items-center justify-center rounded-lg text-white hover:scale-110 transition duration-500">Learn</a>
                </div>
                <div className="w-1/2 flex justify-center">
                    <img src="/homeimage.svg" alt="Two people talking about therapy"/>
                </div>
            </div>
        </div>
    )
